...
class _LiveMatchScreenState extends State<LiveMatchScreen> {
  ...
  Future<void> loadData() async {
    await Get.find<AllMatchesController>()
        ...
        .then((value) {
      if (Get.find<AllMatchesController>().matchOddsModel != null) {
        if (Get.find<AllMatchesController>().matchOddsModel!.sessionOdds !=
            null) {
          checkSession(
              Get.find<AllMatchesController>().matchOddsModel!.sessionOdds!);
        }
      }
    });
    await Get.find<AllMatchesController>()
        ...
        if (Get.find<AllMatchesController>().matchInfoModel!.scorecard !=
          ...
          if (Get.find<AllMatchesController>().matchInfoModel!.live != null) {
            if (Get.find<AllMatchesController>()
                    ...
                    .liveScore !=
                null) {
              calculateTotalBalls(Get.find<AllMatchesController>()
                      .matchInfoModel!
                      .live!
                      .liveScore!
                      .overs ??
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Expanded(
                                                                            child:
                                                                                Text(
                                                                              matchesController.matchInfoModel!.live!.batsmen![index].name ?? "",
                                                                              style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold, fontSize: Dimensions.fontSizeDefault),
                                                                            ),
                                                                          ),
                                                                          Text(
                                                                            matchesController.matchInfoModel!.live!.batsmen![index].runs.toString(),
                                                                            style:
                                                                                TextStyle(color: Colors.black, fontSize: Dimensions.fontSizeDefault),
                                                                          ),
                                                                          const SizedBox(
                                                                            width:
                                                                                20,
                                                                          ...
                                                                          Text(
                                                                            matchesController.matchInfoModel!.live!.batsmen![index].ballsFaced.toString(),
                                                                            style:
                                                                                TextStyle(color: Colors.black, fontSize: Dimensions.fontSizeDefault),
                                                                          ),
                                                                          const SizedBox(
                                                                          ...
                                                                          Text(
                                                                            matchesController.matchInfoModel!.live!.batsmen![index].fours.toString(),
                                                                            style:
                                                                                TextStyle(color: Colors.black, fontSize: Dimensions.fontSizeDefault),
                                                                          ),
                                                                          const SizedBox(
                                                                          ...
                                                                          Text(
                                                                            matchesController.matchInfoModel!.live!.batsmen![index].sixes.toString(),
                                                                            style:
                                                                                TextStyle(color: Colors.black, fontSize: Dimensions.fontSizeDefault),
                                                                          ),
                                                                        ],
                                                  ...
                                                  matchesController
                                                      ...
                                                      ? matchesController
                                                          ...
                                                          ? SizedBox(
                                                              ...
                                                              child: ListView
                                                                  .builder(
                                                                      itemCount: matchesController.matchInfoModel!.live!.bowlers!.length >
                                                                              1
                                                                          ? 1
                                                                          : matchesController
                                                                              .matchInfoModel!
                                                                      ...
                                                                      itemBuilder:
                                                                        ...
                                                                        return Row(
                                                                          ...
                                                                          children: [
                                                                            Expanded(
                                                                              child: Text(
                                                                                matchesController.matchInfoModel!.live!.bowlers![index].name ?? "",
                                                                                style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold, fontSize: Dimensions.fontSizeDefault),
                                                                              ),
                                                                            ),
                                                                            Text(
                                                                              matchesController.matchInfoModel!.live!.bowlers![index].overs.toString(),
                                                                            ...
                                                                            Text(
                                                                              matchesController.matchInfoModel!.live!.bowlers![index].maidens.toString(),
                                                                              style: TextStyle(color: Colors.black, fontSize: Dimensions.fontSizeDefault),
                                                                            ),
                                                                            const SizedBox(
                                                                              width: 20,
                                                                            ...
                                                                            Text(
                                                                              matchesController.matchInfoModel!.live!.bowlers![index].runsConceded.toString(),
                                                                              style: TextStyle(color: Colors.black, fontSize: Dimensions.fontSizeDefault),
                                                                            ),
                                                                            const SizedBox(
                                                                              width: 20,
                                                                            ...
                                                                            Text(
                                                                              matchesController.matchInfoModel!.live!.bowlers![index].wickets.toString(),
                                                                              style: TextStyle(color: Colors.black, fontSize: Dimensions.fontSizeDefault),
                                                                            ),
                                                                          ],
                                                                        );
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          widget.match.competition!.gameFormat == "t20"
                                                                              ? (int.parse(matchesController.matchInfoModel!.live!.liveScore!.runrate!.round().toString()) * 20).toString()
                                                                              : (int.parse(matchesController.matchInfoModel!.live!.liveScore!.runrate!.round().toString()) * 50).toString(),
                                                                          style: TextStyle(
                                                                              color: Colors.white,
                                                                              fontWeight: FontWeight.bold,
                                                                              fontSize: Dimensions.fontSizeLarge),
                                                                    ...
                                                                    child: Row(
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            (int.parse(newSession!.layCondition!) - matchesController.matchInfoModel!.live!.liveScore!.runs!).toString(),
                                                                            style: TextStyle(
                                                                                color: Colors.white,
                                                                                fontWeight: FontWeight.bold,
                                                                                fontSize: Dimensions.fontSizeLarge),
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            (calculateTotalBalls(matchesController.matchInfoModel!.live!.liveScore!.overs!) -
                                                                                        (newSession!.title!.startsWith("6")
                                                                                            ? calculateSessionTotalBalls(6.0)
                                                                                            : newSession!.title!.startsWith("10")
                                                                                                ? calculateSessionTotalBalls(10.0)
                                                                                                : newSession!.title!.startsWith("15")
                                                                                                    ? calculateSessionTotalBalls(15.0)
                                                                                                    : calculateSessionTotalBalls(20.0)))
                                                                                    .toString()
                                                                                    .startsWith("-")
                                                                                ? (calculateTotalBalls(matchesController.matchInfoModel!.live!.liveScore!.overs!) -
                                                                                        (newSession!.title!.startsWith("6")
                                                                    ...
                                                                    child: Row(
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            newSession!.layCondition.toString(),
                                                                            style: TextStyle(
                                                                                color: Colors.white,
                                                                                fontWeight: FontWeight.bold,
                                                                                fontSize: Dimensions.fontSizeLarge),
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            newSession!.backCondition.toString(),
                                                                            style: TextStyle(
                                                                                color: Colors.white,
                                                                                fontWeight: FontWeight.bold,
                                                                                fontSize: Dimensions.fontSizeLarge),
  ...
  SessionOdd? newSession;

  void checkSession(List<SessionOdd> session) {
    for (var i in session) {
      if (i.title!.startsWith("6 over run bhav")) {
        newSession = i;
      } else if (i.title!.startsWith("10 over run bhav")) {
        newSession = i;
      } else if (i.title!.startsWith("15 over run bhav")) {
        newSession = i;
      } else if (i.title!.startsWith("20 over run bhav")) {
        newSession = i;
      }
    }
  }
  ...
  int calculateSessionTotalBalls(double overs) {
    int completeOvers = overs.toInt(); // Get the integer part of overs
    double remainingBalls = (overs - completeOvers) *
        10; // Get the fractional part and convert it to balls
